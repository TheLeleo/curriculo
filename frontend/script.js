...
// adicionar novo projeto no banco de dados CREATE
function Add_proj(){
    let url = '/insertdata';
...
// Carregar Projetos pelo banco de dados READ
...
// Editar um projeto do Banco UPDATE
function Update_proj_modal(){
      let modal_edit = document.querySelector(".proj_crud_box_edit");
      modal_edit.classList.add("modal_show_edit");
}

// Excluir Projetos do Banco DELETE
